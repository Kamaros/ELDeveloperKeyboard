...
class CharacterButton: KeyButton {
    ...
    init(frame: CGRect, primaryCharacter: String, secondaryCharacter: String, tertiaryCharacter: String, delegate: CharacterButtonDelegate) {
        ...
        self.primaryLabel.textColor = UIColor(white: 238.0/255, alpha: 1)
        ...
        self.secondaryLabel.textColor = UIColor(white: 187.0/255, alpha: 1)
        ...
        self.tertiaryLabel.textColor = UIColor(white: 187.0/255, alpha: 1)
